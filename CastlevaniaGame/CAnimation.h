...
class CAnimations     // quan ly cac animation nho
{
	static CAnimations * _instance;

	std::unordered_map<int, LPANIMATION> animations;   // hashmap trong java     //quan ly bang list

public:
	void Add(int id, LPANIMATION ani);    //add cac animation vao list
	LPANIMATION Get(int id); // con tro cho lop do
